...
## Project Structure
    ...
    ├── testapiautostorybo_104958  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_104958`
...
2. Clone this repo and `cd testapiautostorybo_104958`
